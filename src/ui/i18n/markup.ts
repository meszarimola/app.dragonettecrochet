...
export const MARKUP_TEXTS = {
  hu: {
    ...
    guideSnapHint:
      'Az új szem a rácsra, a körrácsra vagy a szomszédos szemre ugrik. Húzás közben a ⌘ (Windowson a Ctrl) lenyomva tartva nem ugrik.',
    ...
    keysFreeFree: 'húzás illesztés nélkül',
  ...
  en: {
    ...
    guideSnapHint:
      'A new stitch jumps to the grid, to the circle guide or to the stitch next to it. Hold ⌘ (Ctrl on Windows) while dragging to move freely.',
    ...
    keysFreeFree: 'drag without snapping',
