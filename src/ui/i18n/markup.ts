...
export const MARKUP_TEXTS = {
  hu: {
    ...
    toolViewMenuTip: 'Nagyítás, rács és segédvonalak',
    ...
    tabsLabel: 'Sorok, rétegek és jelkulcs',
    tabRows: 'Sorok',
    tabLayers: 'Rétegek',
    tabKey: 'Jelkulcs',
    viewWorkLabel: 'Munka közben',
    ...
    keyCustomTitle: 'Saját szem',
    keyCustomNameLabel: 'Név',
    keyCustomAbbrLabel: 'Rövidítés',
    keyCustomGlyphLabel: 'Jel',
    keyCustomAdd: 'Hozzáadás',
    ...
    sectionIrregularTitle: 'Kijelölés',
    propsGroupLabel: 'A kijelölt szemek tulajdonságai',
    propsEmpty: 'Jelölj ki szemet a rajzon, és itt állíthatod a helyét, a méretét és a színét.',
    ...
    guideGridSizeLabel: 'Rács mérete',
    ...
    guideSpacingLabel: 'Gyűrűk távolsága',
    ...
    toolChainArcLabel: 'Ív húzása',
    toolChainArcTip: 'Ív húzása láncszemekből: nyomd le a kezdőpontnál és húzd a végpontig. A kijelölt ív számbillentyűvel állítható.',
    toolLabelChainArc: 'Ív húzása',
    arcTitle: 'Láncív',
    ...
    toolFanLabel: 'Legyező húzása',
    toolFanTip: 'Legyező húzása: kattints az alappontra és húzd az irányba. A kijelölt legyező számbillentyűvel állítható.',
    toolLabelFan: 'Legyező húzása',
    ...
    toolIsolateLabel: 'Kiemelés',
    toolIsolateTip: 'Csak a kijelölt szemek szerkeszthetők, a többi halvány és zárolt. Esc kilép.',
    toolLabelIsolate: 'Kiemelés',
    ...
    exportPictureTitle: 'Kép',
    exportPdfTitle: 'Nyomtatás (PDF)',
    exportClose: 'Bezárás',
    toolExportLabel: 'Exportálás…',
    toolExportTip: 'Kép, SVG vagy nyomtatható PDF mentése',
    toolSettingsLabel: 'Minta beállításai…',
    toolSettingsTip: 'A minta neve, a jelölés és a billentyűk',
    settingsTitle: 'Minta beállításai',
    exportScaleLabel: 'PNG nagyítás',
    exportTransparent: 'Átlátszó háttér',
    exportPageSizeLabel: 'PDF lapméret',
    exportOrientationLabel: 'Tájolás',
    exportAcrossLabel: 'Lapok vízszintesen',
    exportDownLabel: 'Lapok függőlegesen',
    exportPdf: 'PDF',
    ...
    keysFreeAll: 'minden elérhető szem kijelölése; kiemelésben csak a kiemeltek',
    keysFreeNudge: 'a kijelölés mozgatása, Shifttel tízesével',
    keysFreeCopy: 'másolás a vágólapra, beillesztés az egérhez, másolat a kijelölés mellé',
    keysFreeDragSuffix: '+húzás',
    keysFreePan: 'a rajzlap mozgatása',
    keysFreeFree: 'amíg nyomva tartod, semmi nem illeszkedik',
    keysFreeTouch: 'Két ujjal',
    keysFreeTouchHint: 'nagyítás és a rajzlap mozgatása; egy ujj a felvett eszközt használja',
    ...
    keysDuplicate: 'a kijelölés másolása, pl. a következő sorba',
  ...
  en: {
    ...
    toolViewMenuTip: 'Zoom, grid and guides',
    ...
    tabsLabel: 'Rows, layers and key',
    tabRows: 'Rows',
    tabLayers: 'Layers',
    tabKey: 'Key',
    viewWorkLabel: 'While working',
    ...
    keyCustomTitle: 'A stitch of your own',
    keyCustomNameLabel: 'Name',
    keyCustomAbbrLabel: 'Abbreviation',
    keyCustomGlyphLabel: 'Symbol',
    keyCustomAdd: 'Add',
    ...
    sectionIrregularTitle: 'Selection',
    propsGroupLabel: 'Properties of the selected stitches',
    propsEmpty: 'Select stitches on the chart to set their place, size and colour here.',
    ...
    guideSpacingLabel: 'Ring spacing',
    ...
    toolChainArcLabel: 'Draw arc',
    toolChainArcTip: 'Draw a chain arc: press at the start and drag to the end. With an arc selected, digits set the count.',
    toolLabelChainArc: 'Draw arc',
    arcTitle: 'Chain arc',
    ...
    toolFanLabel: 'Draw fan',
    toolFanTip: 'Draw a fan: click the base point and drag in the direction. With a fan selected, digits set the count.',
    toolLabelFan: 'Draw fan',
    ...
    toolIsolateLabel: 'Isolate',
    toolIsolateTip: 'Only the selected stitches can be edited; the rest is faded and locked. Esc leaves.',
    toolLabelIsolate: 'Isolate',
    toolTextLabel: 'Text',
    ...
    exportTitle: 'Export',
    exportPictureTitle: 'Picture',
    exportPdfTitle: 'Print (PDF)',
    exportClose: 'Close',
    toolExportLabel: 'Export…',
    toolExportTip: 'Save a picture, an SVG or a printable PDF',
    toolSettingsLabel: 'Pattern settings…',
    toolSettingsTip: 'The pattern name, the notation and the keys',
    settingsTitle: 'Pattern settings',
    exportScaleLabel: 'PNG scale',
    exportTransparent: 'Transparent background',
    exportPageSizeLabel: 'PDF page size',
    exportOrientationLabel: 'Orientation',
    exportAcrossLabel: 'Pages across',
    exportDownLabel: 'Pages down',
    exportPdf: 'PDF',
    ...
    keysFreeAll: 'select every reachable stitch; while isolating, only the isolated ones',
    keysFreeNudge: 'move the selection, ten at a time with Shift',
    keysFreeCopy: 'copy, paste at the pointer, duplicate',
    keysFreeDragSuffix: '+drag',
    keysFreePan: 'move the drawing area',
    keysFreeFree: 'while it is held, nothing snaps',
    keysFreeTouch: 'Two fingers',
    keysFreeTouchHint: 'zoom and move the drawing area; one finger uses the armed tool',
