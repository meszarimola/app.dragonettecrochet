...
export const MARKUP_TEXTS = {
  hu: {
    ...
    grannyEmpty: 'Add meg, hány szemből áll az első kör, és nyomd meg az „Új kör” gombot.',
    ...
    keysFreeEsc: 'a felvett szem letétele, a kijelölés törlése',
    keysFreeDigits: 'kijelölt láncívnél vagy legyezőnél a szemek száma; egymás után ütve egy szám',
    keysFreeAll: 'minden elérhető szem kijelölése',
  ...
  en: {
    ...
    grannyEmpty: 'Type how many stitches the first round has, then press „New round”.',
