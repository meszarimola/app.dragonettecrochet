...
export const MARKUP_TEXTS = {
  hu: {
    ...
    toolDeleteLastLabel: 'Utolsó törlése',
    toolDeleteLastTip: 'Utolsó lépés törlése (Backspace)',

    // Sor és kör
    toolSameLabel: 'Még egy ugyanabba',
    toolSameTip: 'Még egy ugyanabba – szaporítás (Shift+Enter)',
    toolFillRowLabel: 'Sor kitöltése',
    toolFillRowTip: 'Sor kitöltése a kiválasztott szemmel (Shift+F)',
    toolEndRowLabel: 'Sor vége, fordulás',
    toolEndRowTip: 'Sor vége, fordulás (F)',
    ...
    // Nézet
    toolMirrorLabel: 'Tükrözött nézet',
    toolMirrorTip: 'Tükrözött nézet balkezeseknek (M)',
    toolGridLabel: 'Rács',
    toolGridTip: 'Rács ki és be (R)',
    ...
    shapeBorderLabel: 'Rövidpálcás szegély körben',
    shapeBorderNote:
      'Sorvégenként rövidpálcás sorra 1, pálcásra 2, kétráhajtásosra 3 rp; a sarkokba 3 rp. Ferde élen a lépcsők meghagyott szemeibe 1-1 rp.',
    shapeHdcLabel: 'Félpálcás sorvégre',
    shapeHdcNote: 'A források eltérnek: van, amelyik 1, van, amelyik 2 rövidpálcát ír.',
    shapeBorderRepeatLabel: 'Igazítás a következő szegélysor ismétléséhez',
    shapeBorderXLabel: 'X: a szegélysor ismétlésének szemei',
  ...
  en: {
    ...
    toolDeleteLastLabel: 'Delete last',
    toolDeleteLastTip: 'Delete last step (Backspace)',

    // Row and round
    toolSameLabel: 'Another in the same stitch',
    toolSameTip: 'Another in the same stitch – increase (Shift+Enter)',
    toolFillRowLabel: 'Fill row',
    toolFillRowTip: 'Fill the row with the selected stitch (Shift+F)',
    toolEndRowLabel: 'End of row, turn',
    toolEndRowTip: 'End of row, turn (F)',
    ...
    // View
    toolMirrorLabel: 'Mirrored view',
    toolMirrorTip: 'Mirrored view for left-handers (M)',
    toolGridLabel: 'Grid',
    toolGridTip: 'Grid on and off (R)',
    ...
    shapeBorderLabel: 'Single crochet border all around',
    shapeBorderNote:
      'Per row end: 1 sc on a single crochet row, 2 on a double crochet row, 3 on a treble row; 3 sc into each corner. On a sloped edge, 1 sc into each stitch left by the steps.',
    shapeHdcLabel: 'For a half double crochet row end',
    shapeHdcNote: 'Sources differ: some say 1, some say 2 single crochets.',
    shapeBorderRepeatLabel: 'Adjust to the repeat of the next border row',
    shapeBorderXLabel: 'X: stitches in the border row repeat',
