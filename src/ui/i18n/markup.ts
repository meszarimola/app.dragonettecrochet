...
export const MARKUP_TEXTS = {
  hu: {
    ...
    toolRepeatLabel: 'Körkörös ismétlés',
    toolRepeatTip: 'A kijelölés körbemásolása egy középpont körül',
    toolLabelRepeat: 'Ismétlés',
    ...
    notesTitle: 'Sorszámok és kezdőpontok',
    notesNumbers: 'Sorszámok',
    notesStart: 'Kezdőpont az aktív körre',
    notesHint:
      'A sorszám a sorához tartozik: követi az átrendezést és az irányváltást. A feliratok soha nem számítanak szemnek.',
    exportTitle: 'Kép és PDF',
    ...
    exportPdf: 'PDF mentése',
    exportHint: 'A PNG és az SVG a Fájl menüből megy. Rejtett sor és réteg egyikbe sem kerül bele.',
    bgTitle: 'Háttérkép',
    bgLoad: 'Kép betöltése',
    bgRemove: 'Kép eltávolítása',
    ...
    repeatTitle: 'Körkörös ismétlés',
    repeatCountLabel: 'Példányok (az eredetivel együtt)',
    repeatRangeLabel: 'Tartomány (fok)',
    repeatRun: 'Körbemásolás',
    repeatHint: 'A középpont a körrács közepe. Ha nem látszik a körrács, a kijelölés közepe.',
    ...
    keysFreeCopy: 'másolás, beillesztés az egérhez, duplikálás',
  ...
  en: {
    ...
    toolRepeatLabel: 'Circular repeat',
    toolRepeatTip: 'Copies the selection around a centre',
    toolLabelRepeat: 'Repeat',
    toolTextLabel: 'Text',
    ...
    noteDotted: 'Dotted',
    notesTitle: 'Row numbers and start markers',
    notesNumbers: 'Row numbers',
    notesStart: 'Start marker on the active round',
    notesHint:
      'A row number belongs to its row: it follows reordering and a change of direction. Annotations never count as stitches.',
    exportTitle: 'Picture and PDF',
    ...
    exportPdf: 'Save a PDF',
    exportHint: 'PNG and SVG are in the File menu. Hidden rows and layers go into neither.',
    bgTitle: 'Background image',
    bgLoad: 'Load a picture',
    bgRemove: 'Remove the picture',
    ...
    repeatTitle: 'Circular repeat',
    repeatCountLabel: 'Copies (including the original)',
    repeatRangeLabel: 'Range (degrees)',
    repeatRun: 'Copy around',
    repeatHint: 'The centre is the middle of the circle guide, or of the selection when the guide is hidden.',
